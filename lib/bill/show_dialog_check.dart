...
import 'package:flutter_admin/bill/check_detail.dart';
...
class ShowDialogCheck extends StatelessWidget {
  const ShowDialogCheck({Key? key}) : super(key: key);
